...
- Verdict words (page and replies):
  ...
  - **NO, DO NOT BUY**: negative profit, or the price is more than 4% over the max offer.
  - **NEEDS JUAN'S ATTENTION**: profitable but confidence under 90%, or the price is 0–4% over the max offer.
